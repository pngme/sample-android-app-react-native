...
You can find similar documentation for [Expo](https://github.com/pngme/sample-android-app-react-native-expo), [Flutter](https://github.com/pngme/sample-android-app-flutter) and [Kotlin](https://github.com/pngme/sample-android-app-kotlin).
